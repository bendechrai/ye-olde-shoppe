...
var ItemService = __importStar(require("./items.service"));
var authz_middleware_1 = require("../middleware/authz.middleware");
/**
 * Router Definition
 */
...
// POST items/
exports.itemsRouter.post("/", authz_middleware_1.checkJwt, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var item, e_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
// PUT items/
exports.itemsRouter.put("/", authz_middleware_1.checkJwt, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var item, e_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
// DELETE items/:id
exports.itemsRouter.delete("/:id", authz_middleware_1.checkJwt, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, e_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
